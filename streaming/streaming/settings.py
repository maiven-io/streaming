...
SECRET_KEY = 'django-insecure-u_$v-r=b_*hb!th43=7t@^y88*0%v(h_yv8ie3k_#k0&0wmdt0'
...
CACHES = {
    'default': {
        ...
        'KEY_PREFIX': 'my_project_cache',  # Optional: add a prefix for all your cache keys
    }
}

# Celery settings
CELERY_BROKER_URL = 'redis://127.0.0.1:6379/0'  # Redis as a message broker
